...
[English](runtime_notes.md) | **简体中文**

本文记录使用 `uniubi_motion_client` 和 `uniubi_motion_bridge` 二次开发时容易踩坑的 ROS 2 集成行为。完整 DDS / ROS 2 协议说明统一维护在 [uniubi-docs](https://github.com/uniubi-ai/uniubi-docs/blob/main/README.zh-CN.md)。
...
- 异步控制事件：由所选运行环境的 Event topic 提供
